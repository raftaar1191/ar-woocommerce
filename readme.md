...
[![Build Status](https://travis-ci.org/xwp/wp-ar-woocommerce.svg?branch=master)](https://travis-ci.org/xwp/wp-ar-woocommerce) [![Coverage Status](https://coveralls.io/repos/xwp/wp-ar-woocommerce/badge.svg?branch=master)](https://coveralls.io/github/xwp/wp-ar-woocommerce) [![Built with Grunt](https://cdn.gruntjs.com/builtwith.png)](http://gruntjs.com) [![devDependency Status](https://david-dm.org/xwp/wp-ar-woocommerce/dev-status.svg)](https://david-dm.org/xwp/wp-ar-woocommerce#info=devDependencies) 
